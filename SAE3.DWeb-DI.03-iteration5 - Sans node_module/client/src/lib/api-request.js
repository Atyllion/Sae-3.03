...
let API_URL = "https://mmi.unilim.fr/~donzaud2/SAE3.DWeb-DI.03-iteration5/api/"; // URL de base de l'API (à définir)
...
export {getRequest, postRequest, deleteRequest } // export des fonctions pour les rendre accessibles depuis l'extérieur du module