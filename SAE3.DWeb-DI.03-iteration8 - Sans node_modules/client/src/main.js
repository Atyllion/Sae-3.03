...
// Voir un graphique représentant la répartition des ventes et des locations par genre.
C.Genre = async function () {
  let RentalsGenre = await RentalsData.Genre();
  let SalesGenre = await SalesData.Genre();
  V.renderChart(SalesGenre, RentalsGenre);
};
//

// Voir un graphique représentant la répartition des ventes et des locations par pays.
C.Country = async function () {
  let RentalsCountry = await RentalsData.Country();
  let SalesCountry = await SalesData.Country();
  V.renderChart(SalesCountry, RentalsCountry);
};
//

// Voir un graphique représentant l’évolution de ses ventes et de ses location de film sur les 6 derniers mois.
C.Movies = async function () {
  let RentalsMovies = await RentalsData.Movies();
  let SalesMovies = await SalesData.Movies();
  V.renderChart(SalesMovies, RentalsMovies);
};
// 
...
V.renderChart = function (SalesMovies, RentalsMovies) {
   ChartView.render(SalesMovies, RentalsMovies);
};
